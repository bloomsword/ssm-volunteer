			...
			<div class="modal-body">
				<form id="account_add_from" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="department_function" id="department_function" placeholder="部门主要职责">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="department_description" id="department_description" placeholder="部门总体功能">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                           <input type="text" class="form-control" name="department_createTime" id="department_createTime" placeholder="无需填写，自动生成">
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function detail(department_id) {
        $.ajax({
            type: 'post',
            dataType: 'json',
            url: '<%=request.getContextPath()%>/department/detail',
