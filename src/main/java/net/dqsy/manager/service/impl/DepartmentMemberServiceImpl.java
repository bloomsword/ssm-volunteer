...
public class DepartmentMemberServiceImpl implements IDepartmentMemberService{
	...
	@Override
	public void insertOrUpdate(List<DepartmentMember> lists) {
		departmentMemberMapper.insertOrUpdate(lists);
		
	}

	@Override
	public void update(DepartmentMember member) {
		departmentMemberMapper.update(member);
